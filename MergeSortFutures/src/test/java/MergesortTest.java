...
class MergesortTest {
    ...
    void test(int size) {
        ...
        Collection<Integer> sorted = new Mergesort<Integer>().sort(unsorted);
        assertSorted(unsorted, sorted);
    }

    static <T extends Comparable<? super T>> void assertSorted(final Iterable<Integer> unordered, final Iterable<Integer> sorted) {
